...
class SharedConfigs(object):
    ...
    def __init__(self, desc="shared config for pretraining and finetuning"):
        ...
        parser.add_argument("--lr_mul", default=0.1, type=float,
                            help="initial scale factor for learning rate of visual encoder.")
        parser.add_argument(
        ...
        parser.add_argument("--read_local_data", type=int, choices=[0, 1], default=1,
                            help="local_data. 0: disable, 1 enable")
        parser.add_argument("--queue_size", type=int, default=8192,
                            help="queue size.")
        parser.add_argument("--momentum", type=float, default=0.995,
                            help="momentum.")
        parser.add_argument("--alpha", type=float, default=0.4,
                            help="for retrieval distill.")
    ...
    def get_video_retrieval_args(self):
        ...
        self.parser.add_argument("--distill", type=bool, default=False,
                                 help="")
